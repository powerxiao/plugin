        ...
        if (cityType === 1) {
            ...
            $(self).click(function() {
                ...
                if ($("#popInterCity").length <= 0) {
                    ...
                    for (var i = 0; i < citysLigth; i++) {
                        for (var j = 0; j < cityArr.length; j++) {
                            if (cityArr[j].indexOf(global.citysFlightNew[i][1]) > -1 && global.citysFlightNew[i][1] !== "") {
                                if (i < 55) {
                                    hotCityArr.push(i);
                                }
                ...
                if (cityLimit == 1) {
                    ...
                    $("#popInterCity_title li:last").css("width", "69px");
                } else {
            ...
            $(self).click(function() {
                ...
                if ($("#popInterCityEnd").length <= 0) {
                    ...
                    for (var i = 0; i < citysLigth; i++) {
                        ...
                        for (var j = 0; j < cityArr.length; j++) {
                            if (cityArr[j].indexOf(globalEnd.citysFlightNew[i][1]) > -1 && globalEnd.citysFlightNew[i][1] !== "") {
                                if (i < 55) {
                                    hotCityArr.push(i);
                                }
